...
./build/native/Debug/ex00 convert --in test.webm --out test.opus --title "Dean Town" --artist "VULFPECK" --start-time 10 --end-time 21
./build/native/Debug/ex00 extract-metadata --in test.opus
...
pnpm ts ./src/cpp/ex00-emscripten-cli.ts convert --in test.webm --out test.opus --thumbnail test.jpg --title "Dean Town" --artist "VULFPECK" --start-time 10 --end-time 21
pnpm ts ./src/cpp/ex00-emscripten-cli.ts extract-metadata --in test.opus
```
